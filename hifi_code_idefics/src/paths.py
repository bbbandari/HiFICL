...
if "7fd422" in machine_id:
    ...
    # 2xA100 40G
    coco_dir = "/root/autodl-tmp/data/mscoco2014"
    vqav2_dir = "/root/autodl-tmp/data/vqav2"
    ok_vqa_dir = "/root/autodl-tmp/data/ok_vqa"
    karpathy_coco_caption_dir = "/root/autodl-tmp/data/karpathy-split"
    
    idefics_9b_path = "/root/autodl-tmp/data/models/idefics-9b"
    idefics2_8b_path = "/root/autodl-tmp/data/models/idefics2-8b"
    idefics2_8b_base_path = "/root/autodl-tmp/data/models/idefics2-8b-base"
